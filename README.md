...
> Create a dashboard for DATA 555 Final Project

------------------------------------------------------------------------

## Purpose

The purpose of this dashboard is to help identify difference in self-harm and mental health outcomes across transgender and cisgender populations using real-world clinical data. These insights can inform more equitable healthcare delivery, targeted prevention efforts, and improved mental health support. 
The original research question is how is gender-affirming hormone therapy associated with self-harm/suicide in transgender individuals.
